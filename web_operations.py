...
from snap_operations import download_snapshot, poll_snapshot_status
...
def  reddit_post_retrieval(urls, days_back=10, load_all_replies=False, comment_limit=""):
    ...
    params = {
        "datatset_id": "gd_lvz8ah06191smkebj4",
        "include_errors": "true"
    }
    ...
    for comment in raw_data:
        parsed_comments = {
            ...
            "content": content.get("comment"),
            "date": comment.get("date_posted"),
        }
        parsed_comments.append(parsed_comments)
